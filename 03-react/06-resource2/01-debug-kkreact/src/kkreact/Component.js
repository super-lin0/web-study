...
//setState(批量执行（pendingStates、pendingCallbacks）) -> 批量执行完成 => emitUpdate
//-> updateComponent(更新组件，拿到最新的nextProps、nextState、nextContext) =>
//shouldUpdate(执行shouldComponentUpdate生命周期，更新props\state\context\cache)->
//forceUpdate(更新props\stae\context、cache，执行生命周期（willUpdate），diff,(didUpdate))->
